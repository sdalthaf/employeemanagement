...
<div>
        ...
        <form:form action="updateEmployee"  modelAttribute="employee">
            ...
            <form:input path="emp_id" readonly="true" style="background:lightgray;"/><br/>
            ...
            <form:input path="email_id" readonly="true" style="background:lightgray;"/>
            <form:errors path="email_id" cssClass="error"/><br/><br/>
            
            <form:label path="office_mail">Office mail(*) :</form:label>
            <form:input path="office_mail" readonly="true" style="background:lightgray;"/>
            ...
            <div align="center"><form:button type="submit" name="update" class="button">Submit</form:button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <form:button type="submit" name="cancel" class="buttonC" >Cancel</form:button></div>
        </form:form>
</div> 
</body>
</html>